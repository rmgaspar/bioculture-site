(() => {
  ...
  function translateStatic() {
    const selectors = [...Array.from(document.querySelectorAll('#panorama-global .section-head')).flatMap((_,i)=>[`#panorama-global .section-block:nth-of-type(${i+1}) .eyebrow`,`#panorama-global .section-block:nth-of-type(${i+1}) h2`,`#panorama-global .section-block:nth-of-type(${i+1}) .section-head p`]),'.method-box > .eyebrow','.method-box > h2'];
