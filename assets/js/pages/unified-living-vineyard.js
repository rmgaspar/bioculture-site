(() => {
  ...
  function translateStatic() {
    const selectors = ['.vine-hero .eyebrow','.vine-hero h2','.vine-hero .lead',...Array.from(document.querySelectorAll('.section-head')).flatMap((_,i)=>[`.section-block:nth-of-type(${i+2}) .eyebrow`,`.section-block:nth-of-type(${i+2}) h2`,`.section-block:nth-of-type(${i+2}) .section-head p`]),'.method-box > .eyebrow','.method-box > h2'];
